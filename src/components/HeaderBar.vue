<template>
    <div>
        <div class="h-9 top-header">
            <span class="invisible">Top header</span>
        </div>
            ...
            <div class="container mx-auto">
                <div class="flex p-10 items-center justify-between">
                    <div class="w-3/5">
                        ...
                        <h1 class="font-bold mb-6 font-poppins">
